/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: c2f5d5cac2d2365f71339d4f9bf7d3c8)
// Runtime types generated with workerd@1.20260426.1 2026-04-29 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		IMAGES: ImagesBinding;
		ASSETS: Fetcher;
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* sample */;
	}
}
